...
exports.run = (client, message, args) => {
    ...
    if(!message.member.roles.has("705535101676552242")) return message.channel.send(`Bu komutu kullanabilmek için \`Kullanacak rol adı\` yetkisine sahip olmasınız.`);
...
exports.help = {
  name: 'keremiasdghdürt',
  description: 'DM Duyuru.',
  usage: 'akgjnakhnjaklh'
};