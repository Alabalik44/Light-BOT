...
exports.run = (client, message, args) => {
  if (message.author.id != "482588334422491139") return message.reply('Bunu Sadece Sahibim Kullanabilir');
  ...
  .setColor('RANDOM')
  .setTitle(`**Toygar aşkımdan bir mesajın var bebito**`)
  .setTimestamp()
